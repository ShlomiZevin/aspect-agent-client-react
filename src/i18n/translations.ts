...
export const translations: LanguageConfig = {
  en: {
    ...
    'intel.reports.suggestedEmpty': 'No open suggestions right now — check back after tonight\'s run.',
  ...
  he: {
    ...
    'intel.reports.suggestedEmpty': 'אין הצעות פתוחות כרגע — בדקו שוב אחרי ההרצה הלילית.',
