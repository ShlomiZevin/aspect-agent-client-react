...
const PAGES = [
  ...
  { path: '/lybi/banking-deck', icon: '🏦', title: 'Banking Deck', desc: 'Hila’s banking deck — all 14 slides, plus notes and a suggested version' },
  { path: '/lybi/decision-research', icon: '🔬', title: 'מחקר — איך לומדים מה מוביל לסגירה', desc: 'לגלות אילו מצבים לא-גלויים של אנשים מובילים לסגירה, ומה כדאי לעשות בכל מצב' },
  ...
  { path: '/lybi/installation', icon: '🚀', title: 'Installation — What to Answer', desc: 'Internal: when a customer asks about installation — the answer, the conditions, the red flags' },
  { path: '/lybi/support', icon: '🛟', title: 'Support — What to Answer', desc: 'Internal: hourly on-call developer, bank of hours, coverage and SLA' },
