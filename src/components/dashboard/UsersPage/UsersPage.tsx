    ...
    <div className={styles.page}>
      ...
      <div className={styles.filters}>
        ...
        <label
          ...
          title="Synthetic users are personas created by the Test Runner. Hidden by default."
        >
          <input
            type="checkbox"
            checked={!!filters.includeSynthetic}
            onChange={e => handleFilterChange('includeSynthetic', e.target.checked)}
          />
      ...
      <div className={styles.tableContainer}>
        <table className={styles.table}>
          ...
          <tbody>
            {users.map(user => {
              const isSynthetic = user.metadata?.synthetic === true;
              return (
              <tr key={user.id}>
                <td>
                  ...
                  {isSynthetic && (
                    <span
                      title="Synthetic user — generated by the Test Runner"
